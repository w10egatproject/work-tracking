      ...
      <div className="bg-white rounded-3xl max-w-sm w-full p-6 shadow-2xl border border-slate-200/80 text-center space-y-4 animate-in zoom-in-95 duration-150 relative text-[#0F172A]">
        ...
        <div className="space-y-1.5">
          <h3 className="font-bold text-sm text-[#0F172A]">
            ยืนยันการลบใบสั่งงาน
          </h3>
          <p className="text-xs text-slate-500 leading-relaxed">
            คุณต้องการลบใบสั่งงานนี้ออกจากระบบใช่หรือไม่?
          </p>
        </div>

        {/* Task Info Box */}
        <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-3.5 text-left space-y-1 text-xs">
          <div className="flex items-center gap-2 mb-1">
            <span className="font-bold text-[#005B9A] bg-sky-50 px-2 py-0.5 rounded-md border border-sky-200 font-mono text-[11px]">
        ...
        <p className="text-[11px] text-rose-700 bg-rose-50 border border-rose-200 rounded-xl px-3 py-1.5 flex items-center justify-center gap-1.5 font-medium">
          ...
          <span>แผ่นงาน (Tab) นี้จะถูกลบออกจาก Google Sheets ด้วย</span>
        </p>
